...
resource "aws_route53_record" "dmarc" {
  ...
  ttl     = 300
  records = [
    "v=DMARC1; p=none; rua=mailto:dmarc-reports@${aws_ses_domain_identity.domain.domain}; ruf=mailto:dmarc-reports@${aws_ses_domain_identity.domain.domain}; sp=none; adkim=s; aspf=s"
  ]
}
