...
require (
	buf.build/gen/go/mickamy/sampay/bufbuild/connect-go v1.10.0-20250119130147-583093380e37.2
	buf.build/gen/go/mickamy/sampay/protocolbuffers/go v1.36.3-20250119130147-583093380e37.1
