...
require (
	buf.build/gen/go/mickamy/sampay/bufbuild/connect-go v1.10.0-20250119045223-0ee8523cb307.2
	buf.build/gen/go/mickamy/sampay/protocolbuffers/go v1.36.3-20250119045223-0ee8523cb307.1
