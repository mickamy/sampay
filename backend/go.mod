...
require (
	buf.build/gen/go/mickamy/sampay/bufbuild/connect-go v1.10.0-20250119154437-4f66f56d7222.2
	buf.build/gen/go/mickamy/sampay/protocolbuffers/go v1.36.3-20250119154437-4f66f56d7222.1
