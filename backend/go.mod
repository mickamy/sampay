...
require (
	buf.build/gen/go/mickamy/sampay/connectrpc/go v1.18.1-20250210215004-3424d8c9bf22.1
	buf.build/gen/go/mickamy/sampay/protocolbuffers/go v1.36.5-20250210215004-3424d8c9bf22.1
