...
const (
	...
	// CheckSlugAvailability RPC.
	UserServiceCheckSlugAvailabilityProcedure = "/user.v1.UserService/CheckSlugAvailability"
)
...
type UserServiceClient interface {
	...
	CheckSlugAvailability(context.Context, *connect.Request[v1.CheckSlugAvailabilityRequest]) (*connect.Response[v1.CheckSlugAvailabilityResponse], error)
}
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	return &userServiceClient{
		...
		updateSlug: connect.NewClient[v1.UpdateSlugRequest, v1.UpdateSlugResponse](
			...
			connect.WithSchema(userServiceMethods.ByName("UpdateSlug")),
			connect.WithClientOptions(opts...),
		),
		checkSlugAvailability: connect.NewClient[v1.CheckSlugAvailabilityRequest, v1.CheckSlugAvailabilityResponse](
			httpClient,
			baseURL+UserServiceCheckSlugAvailabilityProcedure,
			connect.WithSchema(userServiceMethods.ByName("CheckSlugAvailability")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
func (c *userServiceClient) UpdateSlug(ctx context.Context, req *connect.Request[v1.UpdateSlugRequest]) (*connect.Response[v1.UpdateSlugResponse], error) {
	return c.updateSlug.CallUnary(ctx, req)
}

// CheckSlugAvailability calls user.v1.UserService.CheckSlugAvailability.
func (c *userServiceClient) CheckSlugAvailability(ctx context.Context, req *connect.Request[v1.CheckSlugAvailabilityRequest]) (*connect.Response[v1.CheckSlugAvailabilityResponse], error) {
	return c.checkSlugAvailability.CallUnary(ctx, req)
}
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	userServiceCheckSlugAvailabilityHandler := connect.NewUnaryHandler(
		UserServiceCheckSlugAvailabilityProcedure,
		svc.CheckSlugAvailability,
		connect.WithSchema(userServiceMethods.ByName("CheckSlugAvailability")),
		connect.WithHandlerOptions(opts...),
	)
	return "/user.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case UserServiceCheckSlugAvailabilityProcedure:
			userServiceCheckSlugAvailabilityHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedUserServiceHandler) CheckSlugAvailability(context.Context, *connect.Request[v1.CheckSlugAvailabilityRequest]) (*connect.Response[v1.CheckSlugAvailabilityResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("user.v1.UserService.CheckSlugAvailability is not implemented"))
}
