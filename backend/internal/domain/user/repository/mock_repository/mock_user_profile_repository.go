...
func (m_2 *MockUserProfile) Upsert(ctx context.Context, m *model.UserProfile) error {
	m_2.ctrl.T.Helper()
...
func (mr *MockUserProfileMockRecorder) Upsert(ctx, m any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upsert", reflect.TypeOf((*MockUserProfile)(nil).Upsert), ctx, m)
}
